...
class ViewController: UIViewController {
    struct Color {
        ...
        static let today = UIColor.red
        static let selectedDay = UIColor.white
        static let weekend = UIColor.brown
        static let notMonthDay = UIColor.lightGray
        
        static let selectedDayBackground = UIColor.darkGray
        static let selectedTodayBackground = UIColor.red
    }
...
extension ViewController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
    ...
    */
    ...
    func shouldShowCustomSingleSelection() -> Bool {
        // true로 변경할 경우 background square로 변함
        return false
    }
...
extension ViewController: CVCalendarViewAppearanceDelegate {
    ...
    func spaceBetweenDayViews() -> CGFloat {
        // circleView의 사이즈 커질수록 줄어듦
        return 15
    }
    
    func dayLabelFont(by weekDay: Weekday, status: CVStatus, present: CVPresent) -> UIFont {
        switch (weekDay, status, present) {
        case (_, .selected, _), (_, .highlighted, _): return UIFont.boldSystemFont(ofSize: 13)
        default: return UIFont.systemFont(ofSize: 13)
        }
    }
    
    func dayLabelColor(by weekDay: Weekday, status: CVStatus, present: CVPresent) -> UIColor? {
        switch (weekDay, status, present) {
        case (_, .selected, _), (_, .highlighted, _): return Color.selectedDay
        case (_, _, .present): return Color.today
        case (.saturday, .in, _), (.sunday, .in, _): return Color.weekend
//        case (.sunday, _, _): return Color.sundayTextDisabled
        case (_, .in, _): return Color.day
        default: return Color.notMonthDay
        }
    }
...
//        case (.sunday, .selected, _), (.sunday, .highlighted, _): return Color.sundaySelectionBackground
        case (_, _, .present): return Color.selectedTodayBackground
        case (_, .selected, _), (_, .highlighted, _): return Color.selectedDayBackground
        default: return nil
        }
    }
}
